...
class GameScene: SKScene {
    ...
    override func didMoveToView(view: SKView) {        
        ...
        let tunnel1 = Tunnel(orientation:TunnelOrientation.verticalTunnel, length: 13, gridX: 0, gridY: 0, colorAlpha: 1.0)
        self.addChild(tunnel1.tunnelSpriteNode)
        let tunnel2 = Tunnel(orientation:TunnelOrientation.verticalTunnel, length: 13, gridX: 1, gridY: 0, colorAlpha: 1.0)
        self.addChild(tunnel2.tunnelSpriteNode)
        let tunnel3 = Tunnel(orientation:TunnelOrientation.verticalTunnel, length: 13, gridX: 2, gridY: 0, colorAlpha: 1.0)
        ...
        let tunnel5 = Tunnel(orientation:TunnelOrientation.verticalTunnel, length: 13, gridX: 4, gridY: 0, colorAlpha: 1.0)
        self.addChild(tunnel5.tunnelSpriteNode)
        let tunnel6 = Tunnel(orientation:TunnelOrientation.verticalTunnel, length: 13, gridX: 5, gridY: 0, colorAlpha: 1.0)
        self.addChild(tunnel6.tunnelSpriteNode)
        let tunnel7 = Tunnel(orientation:TunnelOrientation.verticalTunnel, length: 13, gridX: 6, gridY: 0, colorAlpha: 1.0)
        self.addChild(tunnel7.tunnelSpriteNode)
        let tunnel8 = Tunnel(orientation:TunnelOrientation.horizontalTunnel, length: 8, gridX: 0, gridY: 0, colorAlpha: 1.0)
        self.addChild(tunnel8.tunnelSpriteNode)
        let tunnel9 = Tunnel(orientation:TunnelOrientation.horizontalTunnel, length: 8, gridX: 0, gridY: 1, colorAlpha: 1.0)
        self.addChild(tunnel9.tunnelSpriteNode)
        let tunnel10 = Tunnel(orientation:TunnelOrientation.horizontalTunnel, length: 8, gridX: 0, gridY: 2, colorAlpha: 1.0)
        self.addChild(tunnel10.tunnelSpriteNode)
        let tunnel11 = Tunnel(orientation:TunnelOrientation.horizontalTunnel, length: 8, gridX: 0, gridY: 3, colorAlpha: 1.0)
        self.addChild(tunnel11.tunnelSpriteNode)
        let tunnel12 = Tunnel(orientation:TunnelOrientation.horizontalTunnel, length: 8, gridX: 0, gridY: 4, colorAlpha: 1.0)
        self.addChild(tunnel12.tunnelSpriteNode)
        let tunnel13 = Tunnel(orientation:TunnelOrientation.horizontalTunnel, length: 8, gridX: 0, gridY: 5, colorAlpha: 1.0)
        self.addChild(tunnel13.tunnelSpriteNode)
        let tunnel14 = Tunnel(orientation:TunnelOrientation.horizontalTunnel, length: 8, gridX: 0, gridY: 6, colorAlpha: 1.0)
        self.addChild(tunnel14.tunnelSpriteNode)
        let tunnel15 = Tunnel(orientation:TunnelOrientation.horizontalTunnel, length: 8, gridX: 0, gridY: 7, colorAlpha: 1.0)
        self.addChild(tunnel15.tunnelSpriteNode)
        let tunnel16 = Tunnel(orientation:TunnelOrientation.horizontalTunnel, length: 8, gridX: 0, gridY: 8, colorAlpha: 1.0)
        self.addChild(tunnel16.tunnelSpriteNode)
        let tunnel17 = Tunnel(orientation:TunnelOrientation.horizontalTunnel, length: 8, gridX: 0, gridY: 9, colorAlpha: 1.0)
        self.addChild(tunnel17.tunnelSpriteNode)
        let tunnel18 = Tunnel(orientation:TunnelOrientation.horizontalTunnel, length: 8, gridX: 0, gridY: 10, colorAlpha: 1.0)
        self.addChild(tunnel18.tunnelSpriteNode)
        let tunnel19 = Tunnel(orientation:TunnelOrientation.horizontalTunnel, length: 8, gridX: 0, gridY: 11, colorAlpha: 1.0)
