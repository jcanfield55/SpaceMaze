...
class GameScene: SKScene {
    ...
    /* Properties */
    var OpSpeed:TimeInterval = 2.5
    let color = UIColor(red:0.1, green:0.15, blue:0.3, alpha:1.0)
    var mainCharacter:MainCharacter?
    var opponentMoveTiming:TimeInterval = 3  // number of seconds between opponent movement
    ...
    override func didMove(to view: SKView) {        
        ...
        run(SKAction.playSoundFileNamed("Ultimate.mp3", waitForCompletion: false))
        ...
        self.gameResultLabel.fontColor = UIColor.purple
