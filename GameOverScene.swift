...
class GameOverScene: SKScene {
    ...
    var tryAgainButton:SKSpriteNode = SKSpriteNode(imageNamed: "cat")
    ...
    override func touchesBegan(touches: Set<NSObject>, withEvent event: UIEvent) {
        ...
        for touch in touches {
            if let touchtouch:UITouch = touch as? UITouch {
                let touchLocation:CGPoint = touchtouch.locationInNode(self)
